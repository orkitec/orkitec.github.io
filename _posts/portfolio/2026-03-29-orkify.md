...
Role-based permissions, project-scoped API keys, encrypted secrets, and database-level data isolation. Built for small teams that don't need enterprise complexity.
